...
export declare const eventRucula: {
    RESET_BACKGROUND: string;
    RESET_BACKGROUND_EVENT: Event;
    BEFORE_SEND_OBJECT_HTTP: string;
    EVENT_BEFORE_SEND_OBJECT_HTTP: Event;
    AFTER_SEND_OBJECT_HTTP: string;
    EVENT_AFTER_SEND_OBJECT_HTTP: Event;
    SEND_OBJECT_HTTP_OK: string;
    EVENT_SEND_OBJECT_HTTP_OK: Event;
    SEND_OBJECT_HTTP_ERROR: string;
    EVENT_SEND_OBJECT_HTTP_ERROR: Event;
};
